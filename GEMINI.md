...
- Quản lý sản phẩm: quần áo và giày dép, màu sắc, size, tồn kho theo chi nhánh và kho
...
- Tích hợp webhook để tư vấn sản phẩm qua messenger và zalo (nếu còn thời gian)
## Chi tiết nghiệp vụ
...
- Tìm sản phẩm theo tên, code, size và màu
- Mỗi sản phẩm có:
  - Tên sản phẩm, danh mục, thương hiệu
  - Màu sắc, size, giá nhập, giá bán, hình ảnh khối lượng trung bình
- Tồn kho chi tiết:
...
### 3. Chính sách đặt cọc (nếu có thêm thời gian phát triển)
...
- Sử dụng **API Giao Hàng Nhanh**:
  - Tạo các cửa hàng trên giao hàng nhanh để tích hợp tính năng tính phí
...
### 8. Khuyến mãi 
- Khuyến mãi theo khung giờ hay theo ngày nhất định 

### 9. Banner 
- Banner có thể set cho các vị trí như bên trái, phải hay trang chủ
- Banner có thể set thời gian hoạt động 
