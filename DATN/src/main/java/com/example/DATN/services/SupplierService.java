...
public class SupplierService {
    ...
    public SupplierResponse getSupplierById(String id) {
        ...
        Supplier supplier = supplierRepository.findById(stringToUUID(id))
                .orElseThrow(() -> new ApplicationException(ErrorCode.SUPPLIER_NOT_FOUND));
        return supplierMapper.toSupplierResponse(supplier);
    }

    @Transactional
    public SupplierResponse updateSupplier(String SupllierId, SupplierRequest request) {
        UUID id =stringToUUID(SupllierId);
    ...
    public void deleteSupplier(String id) {
        if (!supplierRepository.existsById(stringToUUID(id))) {
            throw new ApplicationException(ErrorCode.SUPPLIER_NOT_FOUND);
        }
        supplierRepository.deleteById(stringToUUID(id));
    }
}
